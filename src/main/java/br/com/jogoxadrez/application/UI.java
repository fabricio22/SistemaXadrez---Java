...
public class UI {
	...
	// https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
		...
		public static PosicaoXadrez leituraPosicaoPecaXadrez(Scanner sc) {
			try {
			...
			return new PosicaoXadrez(coluna, linha);
				...
				throw new InputMismatchException("Erro ao ler a posição do xadrez. Valores válidos a1 até h8.");
			}
		}
